...
class FqprVisualizations:
    ...
    def _parse_plot_mode(self, mode):
        """
    ...
    def soundings_plot_3d(self, mode='svcorr', sec_idx=None, tme=None):
        """
        ...
        Parameters
        ----------
        mode: str, either 'svcorr' to plot the svcorrected offsets, or 'georef' to plot the georeferenced soundings
        sec_idx: int, optional if you wish to only plot that sector
    ...
    def soundings_plot_2d(self, mode='svcorr', color_by='depth', sec_idx=None, tme=None):
        """
        ...
        ----------
        mode: str, either 'svcorr' to plot the svcorrected offsets, or 'georef' to plot the georeferenced soundings
        color_by: str, either 'depth' or 'sector'
        sec_idx: int, optional if you wish to only plot that sector
        tme: float, optional if you wish to only plot for that time
    ...
    def _generate_orientation_vector(self, sec_idx, tme=None):
        """
    ...
    def visualize_orientation_vector(self, sec_idx=None):
        """
    ...
    def visualize_beam_pointing_vectors(self, corrected=False):
        """
        ...
        Parameters
        ----------
        corrected: bool, if True uses the 'corr_pointing_angle' variable that is corrected for mounting angles/attitude,
...
def save_animation_mpeg(anim_instance, output_pth):
    ...
    Parameters
    ----------
    anim_instance: Matplotlib FuncAnimation object
    output_pth: str, path to where you want the mpeg to be generated
