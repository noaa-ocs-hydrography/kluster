...
ping_chunks = {'time': (ping_chunk_size,), 'beam': (max_beams,), 'xyz': (3,),
               ...
               'fixedgain': (ping_chunk_size, max_beams),
...
subset_variable_selection = ['head', 'time', 'beam', 'absorption', 'acrosstrack', 'alongtrack', 'altitude', 'backscatter', 'beampointingangle', 'corr_altitude',
                             'corr_heave', 'corr_pointing_angle', 'counter', 'datum_uncertainty', 'delay', 'depthoffset', 'detectioninfo', 'fixedgain',
...
subset_variable_2d = ['absorption', 'acrosstrack', 'alongtrack', 'backscatter', 'beampointingangle', 'corr_pointing_angle', 'datum_uncertainty', 'delay',
                      'depthoffset', 'detectioninfo', 'frequency', 'geohash', 'nearnormalcorrect', 'processing_status', 'pulselength', 'fixedgain',
...
variables_by_key = {'multibeam': ['absorption', 'acrosstrack', 'alongtrack', 'backscatter', 'beampointingangle', 'corr_altitude', 'corr_heave',
                                  'corr_pointing_angle', 'counter', 'delay', 'depthoffset', 'detectioninfo', 'fixedgain',
...
variable_translator = {'absorption': 'Absorption', 'acrosstrack': 'SoundVelocity_AcrossTrack', 'alongtrack': 'SoundVelocity_AlongTrack',
                       ...
                       'detectioninfo': 'Beam_Filter', 'frequency': 'Beam_Frequency', 'geohash': 'Geohash', 'fixedgain': 'Fixed_Gain',
                       'latitude': 'Latitude', 'longitude': 'Longitude', 'mode': 'Ping_Mode',
                       'modetwo': 'Ping_Mode_Two', 'nearnormalcorrect': 'Near_Normal_Correction', 'processing_status': 'Processing_Status',
...
variable_reverse_lookup = {'Absorption': 'absorption', 'Backscatter': 'backscatter',
                           ...
                           'Pulse_Length': 'pulselength', 'TVG': 'tvg', 'Fixed_Gain': 'fixedgain',
                           ...
                           'Geohash': 'geohash', 'Near_Normal_Correction': 'nearnormalcorrect',
...
variable_descriptions = {'absorption': 'The mean absorption coefficient in dB/km used by the multibeam during TVG correction.  Used during backscatter to remove multibeam applied gain.',
                         ...
                         'fixedgain': 'The fixed gain applied to the raw reflectivity in dB, used during backscatter processing to remove the gain',
                         ...
                         'nearnormalcorrect': 'Backscatter TVG corrector built during .all conversion in dB, will allow Kluster to back out the "flattening" corrector applied to backscatter in .all files',
                         ...
                         'pulselength': 'Duration of the transmit pulse in seconds, used during backscatter processing',
                         ...
                         'reflectivity': 'The raw reflectivity or backscatter intensity from the multibeam in dB.  In decibels, represents the intensity of the beam return, uncorrected for things like sonar settings and transmission loss.',
