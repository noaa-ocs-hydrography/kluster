...
`conda create -n kluster_test -c conda-forge python=3.11.8 qgis=3.36.0 vispy=0.14.2 pyside2=5.15.8 gdal=3.8.4 h5py python-geohash`

`conda activate kluster_test`

`pip install pyqtgraph==0.13.4 git+https://github.com/noaa-ocs-hydrography/kluster.git#egg=hstb.kluster`
